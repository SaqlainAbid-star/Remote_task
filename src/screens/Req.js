        ...
        <View style={styles.container}>
            ...
            <View style={styles.userRow}>
                <Image
                    ...
                    style={styles.avatar} />
                <Text style={styles.userName}>Makenna</Text>
            </View>


            <Text style={styles.userName}>Type Req Title Here</Text>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                ...
                <TouchableOpacity style={styles.button} onPress={handleUpload}>
                    <Ionicons name="attach-outline" size={28} color={COLORS.theme} />
            ...
            <TouchableOpacity style={styles.submit} onPress={handleSubmit}>
                <Text style={[styles.buttonText,{color:COLORS.white}]}>Send</Text>
            </TouchableOpacity>
