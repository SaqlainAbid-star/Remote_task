...
import { View, Text, FlatList, Image, StyleSheet, TextInput, TouchableOpacity, Alert, Modal } from 'react-native';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.user}>
                <Image
                    ...
                    style={styles.avatar} />
                <Text style={styles.userName}>Charlie</Text>
            </View>
            ...
            <Text style={styles.userName}>Type Your Review Here</Text>
            ...
            <TouchableOpacity style={styles.submit} onPress={handleSubmit}>
                <Text style={[styles.buttonText, { color: COLORS.white }]}>Post Review</Text>
            </TouchableOpacity>
                ...
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        ...
                        <>
                            ...
                            <Text style={{ fontSize: 16, margin: 10, color: COLORS.black }}>Review Posted</Text>

                            <Text style={{ fontSize: 12, margin: 10, color: COLORS.liteBlack }}>You have successfully posted review.</Text>
